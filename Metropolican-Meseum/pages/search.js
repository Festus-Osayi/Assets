                  ...
                  <Row>
                      ...
                      <Col md={4}>
                          <Form.Group className="mb-3">
                              ...
                              <Form.Control type="text" placeholder="" {...register('geoLocation')} pattern='[A-Za-z]{4,}' 
                              title='four or more letters'
                      ...
                      <Col md={4}>
                          <Form.Group className="mb-3">
                              ...
                              <Form.Control type="text" placeholder="" {...register('medium')} pattern='[A-Za-z]{4,}'
                                  title='four or more letters' />
                              <Form.Text className="text-muted">
